...
W = softmaxWeightTrain(X_train, Y_train, iterNum, Winit, alpha);

Ctrain = multiClassLinearClassifier(W, X_train);
Ctest = multiClassLinearClassifier(W, X_test);

[train_err, CONF] = benchmarkClassification(Ctrain, Y_train);
[test_err, CONF] = benchmarkClassification(Ctest, Y_test);

train_err
test_err

% Error rate of Softmax weight training
...
% Error rate of Perceptron weight training
